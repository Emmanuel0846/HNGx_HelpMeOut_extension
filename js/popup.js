...
$(document).ready(function(){
    ...
    chrome.storage.sync.get(null, function(result) {
        ...
        if ($(".type-active").attr("id") == "tab-only") {
           $(".type-active").find("img").attr("src", chrome.extension.getURL('../assets/tab.svg'));
        } else if ($(".type-active").attr("id") == "desktop") {
           $(".type-active").find("img").attr("src", chrome.extension.getURL('../assets/monitor.svg'));
        ...
        if ($("#"+result.type).attr("id") == "tab-only") {
           $("#"+result.type).find("img").attr("src", chrome.extension.getURL('../assets/tab.svg'));
        } else if ($("#"+result.type).attr("id") == "desktop") {
           $("#"+result.type).find("img").attr("src", chrome.extension.getURL('../assets/monitor.svg'));
    ...
    $(document).on("click", ".type:not(.type-active)", function(){
       ...
       if ($(this).attr("id") == "tab-only") {
           $(this).find("img").attr("src", chrome.extension.getURL('../assets/tab.svg'));
       } else if ($(this).attr("id") == "desktop") {
           $(this).find("img").attr("src", chrome.extension.getURL('../assets/monitor.svg'));
